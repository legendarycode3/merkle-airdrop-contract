...
Instead of storing the complete waitlist and individual token allocations directly onchain, the project uses a `Merkle tree` to effectively represent and verify claim
