...
Build with `Solidity`, `Foundry`, `OpenZeppelin`, `Murky` and `Foundry DevOps`, the project demonstrates a gas-effecient approach to verifying a large whitelist on-chain 
