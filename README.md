...
* **Double-Claim Protection:** The contract maintains a `_hasClaimed` mapping to track successfu claims. Once an account has completed a valid claim, subsequent attempts from thesame account are  
